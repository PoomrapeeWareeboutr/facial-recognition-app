        ...
        <div class="mt-5">
          ...
          <form>
            <div class="grid gap-y-4">
              ...
              <!-- Form Group -->
              <div>
                <label for="face-id" class="block text-sm mb-2 dark:text-white"
                  >Face ID</label
                >
                <div class="relative">
                  <div
              ...
              <p v-if="!usernameMatch" class="text-xs text-red-600 mt-2">
                The username is not match.
              </p>
              <p v-if="usernameExist" class="text-xs text-red-600 mt-2">
                This username already exists.
              </p>
              <!-- End Form Group -->
              <button
                :disabled="isAllowToSubmit ? false : true"
